...
class _SettingsProfileScreenState extends State<SettingsProfileScreen> {
  ...
  void initState() {
    ...
    _nameController.text =
        profile.name == 'Guest' ? '' : profile.name;
    _ageController.text =
        profile.age == 0 ? '' : '${profile.age}';
    _goalController.text =
        profile.weightGoal == 0.0 ? '' : '${profile.weightGoal}';
  ...
  void _saveProfile() {
    ...
    if (goal != null) provider.updateWeightGoal(goal);
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          ...
          'Your app preferences (unit system, rest timer, notifications) '
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: _inputDecoration(
                    'Your Name', 'e.g. Alex', Icons.badge_outlined),
                validator: (v) {
                  if (v != null &&
                      v.trim().isNotEmpty &&
                      v.trim().length < 2) {
              ...
              TextFormField(
                ...
                style: const TextStyle(color: Colors.white),
                decoration: _inputDecoration(
                    'Age', 'e.g. 25', Icons.cake_outlined),
                validator: (v) {
              ...
              Slider(
                ...
                onChangeEnd: (val) => context
                    .read<ProfileProvider>()
                    .updateRestTimer(val.toInt()),
              ),
              Padding(
  ...
  InputDecoration _inputDecoration(
    ...
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(10),
        borderSide:
            const BorderSide(color: Color(0xFF2DE394)),
      ),
