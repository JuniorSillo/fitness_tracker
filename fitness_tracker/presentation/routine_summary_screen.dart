  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: routine.isEmpty
          ...
          : _buildContent(context, provider, routine, breakdown, maxCount),
    );
  }
  ...
  Widget _buildStatsHeader(RoutineProvider provider) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _statChip(Icons.list_rounded,
              '${provider.exerciseCount}', 'Exercises'),
          _statChip(Icons.repeat_rounded,
              '${provider.totalSets}', 'Total Sets'),
          _statChip(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Clear Routine',
            style: TextStyle(
                color: Colors.white, fontWeight: FontWeight.bold)),
        content: const Text(
          'Are you sure you want to remove all exercises from your routine?',
